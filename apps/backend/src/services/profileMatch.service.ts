...
export class ProfileMatchService {
   ...
   * Used by PoiBoundsService.getPois to seed the map's POI layer.
   *
   ...
   * viewer being present in the results to detect "I'm alone on the map"
   * and render the NoResultsCTA.
   */
