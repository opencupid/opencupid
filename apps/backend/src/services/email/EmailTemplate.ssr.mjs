...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ style: { "margin": "0", "padding": "0", "background": "#f6f7f9" } }, _attrs))}><table role="presentation" class="outer" cellpadding="0" cellspacing="0"><tbody><tr><td class="center"><table role="presentation" class="card" width="600" cellpadding="0" cellspacing="0"><tbody><tr><td class="header"><div class="appName">${ssrInterpolate(__props.siteName)}</div></td></tr><tr><td class="body"><div class="content">${ssrInterpolate(__props.contentBody)}</div><table role="presentation" class="ctaTable" cellpadding="0" cellspacing="0"><tbody><tr><td class="ctaCell"><a${ssrRenderAttr("href", __props.callToActionUrl)} class="ctaButton">${ssrInterpolate(__props.callToActionLabel)}</a></td></tr></tbody></table><p class="fallback">${ssrInterpolate(__props.fallbackHint)} <br><a${ssrRenderAttr("href", __props.callToActionUrl)} class="link">${ssrInterpolate(__props.callToActionUrl)}</a></p></td></tr><tr><td class="footer">`);
      if (__props.footer) {
