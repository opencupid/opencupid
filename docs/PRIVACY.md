...
OpenCupid records lightweight session timestamps (start and end times only) when users interact with the platform. No behavioral content is stored — sessions contain no IP addresses, device information, request paths, or event payloads.
